...
To create bindings that will be visible when the generated module is opened in the \texttt{REPL}, one must transform regular racket symbols into syntax objects with proper scope.

...
Effectful operations are invoked similarly to function calls and are handled using \textit{handle} construct, they may also be lifted with \textit{lift} syntactic form.
